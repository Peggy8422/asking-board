...
import { HomeIcon, HotIcon, UsersIcon, SettingIcon, HandIcon, LogoutIcon } from '../assets/icons';
...
const Sidebar: React.FC<SidebarProps> = (props) => {
  return (
    ...
    > 
      <Container width={'80%'}>
        <Text ml={'15px'} fontSize={'lg'} fontWeight={'bold'} color={'brand.500'}>Hi, {props.userName}</Text>
